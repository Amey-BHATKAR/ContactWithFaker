...
use Adipsys\testBundle\Entity\Address;
use Adipsys\testBundle\Form\AddressType;
...
class AddressController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('AdipsystestBundle:Address')->findAll();
     ...
     * @Method("POST")
     * @Template("AdipsystestBundle:Address:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('AdipsystestBundle:Address')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("AdipsystestBundle:Address:edit.html.twig")
     */
