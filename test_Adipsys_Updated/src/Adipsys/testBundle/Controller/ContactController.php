...
namespace Adipsys\testBundle\Controller;
...
use Adipsys\testBundle\Entity\Contact;
use Adipsys\testBundle\Form\ContactType;
...
class ContactController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('AdipsystestBundle:Contact')->findAll();
     ...
     * @Method("POST")
     * @Template("AdipsystestBundle:Contact:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('AdipsystestBundle:Contact')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("AdipsystestBundle:Contact:edit.html.twig")
     */
